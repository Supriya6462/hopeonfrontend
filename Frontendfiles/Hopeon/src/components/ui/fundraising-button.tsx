...
export interface FundraisingButtonProps
  extends React.ButtonHTMLAttributes<HTMLButtonElement>,
    VariantProps<typeof fundraisingButtonVariants> {
  asChild?: boolean;
  loading?: boolean;
  loadingText?: string;
}

const FundraisingButton = React.forwardRef<HTMLButtonElement, FundraisingButtonProps>(
  (
    {
      className,
      variant,
