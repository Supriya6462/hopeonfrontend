...
export default function CampaignCard({ id, title, imageSrc, target, raised }: CampaignCardProps) {
  ...
  return (
    <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] overflow-hidden border border-gray-100 relative">
      {/* Image Container */}
